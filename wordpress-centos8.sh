...
# Setting parameters
WPC8_MYSQL_WORDPRESS_DATABASE="wordpress_database"
WPC8_MYSQL_WORDPRESS_USER="wordpress_user"
WPC8_MYSQL_WORDPRESS_PASSWORD="wordpress_password"
WPC8_MYSQL_ROOT_PASSWORD="root_password"
...
WPC8_DATABASE_TABLES_PREFIX="wp_"
...
sed -i "s|^define('DB_NAME',.*|define('DB_NAME', '"$WPC8_MYSQL_WORDPRESS_DATABASE"');|g ; 
		...
		s|^\$table_prefix =.*|\$table_prefix = '"$WPC8_DATABASE_TABLES_PREFIX"';|g" wordpress/wp-config.php
